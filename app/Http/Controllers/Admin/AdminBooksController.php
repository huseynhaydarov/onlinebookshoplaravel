...
class AdminBooksController extends AdminBaseController
{
    ...
    public function store(BooksCreateRequest $request)
    {
        ...
        return redirect('/admin/books')
            ->with('success_message', 'Книга успешно создана');
    }
    ...
    public function update(BooksUpdateRequest $request, $id)
    {
        ...
        $book->update($input);
        return redirect('/admin/books')
            ->with('success_message', 'Книга успешно обновлена');
    }
    ...
    public function destroy($id)
    {
        $book = Book::findOrFail($id);
        $book->delete();
        return redirect()->back()->with('alert_message', 'Книга перемещена в корзину');
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->back()
            ->with('success_message', 'Книга успешно восстановлена из корзины');
    }
    ...
    public function forceDelete($id)
    {
        ...
        return redirect()->back()
            ->with('alert_message', 'Книга удалена навсегда');
    }
    ...
    {
        $discount_books = "Все книги со скидкой";
