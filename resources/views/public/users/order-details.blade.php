...
@section('content')
<div class="container">
    <h4 class="my-4 p-4 bg-light">Детали заказа</h4>
    ...
    <div class="order-product mb-4">
        ...
        <tr>
          ...
          <td>{{$order_detail->price}}с</td>
          <td>{{$order_detail->price * $order_detail->book_quantity}}с</td>
        </tr>
        @endforeach
        <tr>
            <td colspan="2"></td>
            <td><strong>Итого</strong></td>
            <td><strong>{{$order->total_price}}с</strong></td>
        </tr>
        </tbody>
        </table>
    </div>
